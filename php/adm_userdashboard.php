		...
		<div class="textCard">
			<div class="card-container">
				...
				<div class="painelcard">
					...
					<hr>
					<h3><a href="adm_gerenciar_users.php">GERENCIAR USUÁRIOS</a></h3>
					<hr>
					<h3><a href="adm_gerenciar_excursoes.php">GERENCIAR TODAS EXCURSÕES</a></h3>
					<hr>
					<h3><a href="adm_relatorios.php">EMITIR RELATÓRIOS</a></h3>
					<hr>
					<h3><a href="adm_gerenciar_chamados.php">GERENCIAR CHAMADOS</a></h3>
					<hr>
