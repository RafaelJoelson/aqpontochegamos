...
if (isset($id)) {
    ...
    // Verifica se a data de chegada é anterior à data de partida
    if ($dataChegada < $dataPartida) {
        header("Location: erro.php?code=24");
        exit;
    }
    // Verifica se a data de retorno é anterior à data de chegada
    if ($dataRetorno < $dataChegada) {
        header("Location: erro.php?code=25");
        exit;
    }
