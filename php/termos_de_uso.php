	...
	<main>
      ...
      <div class="textCard">
        ...
        <h1>Contrato de Termos de Uso</h1>
            ...
            <p>Ao clicar no botão "Aceito", o Usuário reconhece ter lido e compreendido este Contrato e concorda em cumpri-lo integralmente.</p>
            <script>
          ...
          <div class="aceitoTermos">
            <input type="checkbox" id="aceitoTermos"> <label for="aceitoTermos">Eu li e concordo com os termos de uso</label><br>
            <button onclick="verificarAceite()">Aceitar e prosseguir</button>
