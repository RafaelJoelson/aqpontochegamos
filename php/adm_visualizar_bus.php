...
<head>
    ...
    <title>ADM Visualizar Excursão </title>
    <link rel="stylesheet" type="text/css" href="../css/admindex-styles.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="../css/admslides-style.css" media="screen" />
...
<body>
	<main>
		<header>
			...
			<ul class="navmap">
				<li><a href="adm_userdashboard.php">> Meu perfil</a></li>
